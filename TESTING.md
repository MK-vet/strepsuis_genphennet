# Testing Guide for strepsuis-genphennet

This document describes how to run tests locally and in CI/CD for the strepsuis-genphennet package.
...
```bash
pytest --cov=strepsuis_genphennet --cov-report=term-missing
```
...
```python
import pytest
from strepsuis_genphennet.analyzer import MDRAnalyzer
