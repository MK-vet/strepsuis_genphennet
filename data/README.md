...
strepsuis-genphennet analyze --data-dir ../../data/ --output ./results/

# Or from the main repository root
strepsuis-genphennet analyze --data-dir ./data/ --output ./separated_repos/strepsuis-genphennet/results/
```
...
# Run network analysis with example data
strepsuis-genphennet analyze \
