...
The following versions of StrepSuis-GenPhenNet are currently being supported with security updates:
...
- StrepSuis-GenPhenNet version affected
...
When using StrepSuis-GenPhenNet:
