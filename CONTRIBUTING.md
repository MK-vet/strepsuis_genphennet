# Contributing to StrepSuis-GenPhenNet

Thank you for your interest in contributing to StrepSuis-GenPhenNet! This document provides guidelines and instructions for contributing.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR-USERNAME/strepsuis-genphennet.git
   cd strepsuis-genphennet
   ```
3. **Add upstream remote**:
   ```bash
   git remote add upstream https://github.com/MK-vet/strepsuis-genphennet.git
   ```
