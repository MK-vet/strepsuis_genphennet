# Multi-stage build for StrepSuis-GenPhenNet
# Stage 1: Builder - Install dependencies and package
FROM python:3.11-slim as builder

LABEL maintainer="MK-vet <support@strepsuis-suite.org>"
LABEL description="StrepSuis-GenPhenNet: Network-Based Integration of Genome-Phenome Data"
LABEL version="1.0.0"
...
HEALTHCHECK --interval=30s --timeout=3s --start-period=5s --retries=3 \
    CMD strepsuis-genphennet --version || exit 1

# Set the entrypoint to the CLI command
ENTRYPOINT ["strepsuis-genphennet"]
